...
If more than one page was updated, or if a CLAUDE.md architecture section changed, trigger `skaildev-devlog` to record a plain-language summary of what was brought back in sync and why it had drifted.
