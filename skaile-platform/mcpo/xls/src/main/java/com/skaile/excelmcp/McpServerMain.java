...
import com.skaile.excelmcp.tools.namedrange.NamedRangeGetTool;
import com.skaile.excelmcp.tools.namedrange.NamedRangeListTool;
import com.skaile.excelmcp.tools.range.RangeClearTool;
import com.skaile.excelmcp.tools.range.RangeGetTool;
import com.skaile.excelmcp.tools.range.RangeSetStyleTool;
...
import com.skaile.excelmcp.tools.sheet.SheetSetFormatTool;
import com.skaile.excelmcp.tools.table.TableGetTool;
import com.skaile.excelmcp.tools.table.TableListTool;
import com.skaile.excelmcp.tools.vba.VbaGetModuleTool;
import com.skaile.excelmcp.tools.vba.VbaListModulesTool;
...
public final class McpServerMain {
  ...
  public static void main(String[] args) {
    ...
    tools.register(new RangeSetStyleTool(engine));
    ...
    tools.register(new SheetSetFormatTool(engine));
    ...
    tools.register(new TableListTool(engine));
    tools.register(new TableGetTool(engine));
    tools.register(new NamedRangeListTool(engine));
    tools.register(new NamedRangeGetTool(engine));
    tools.register(new VbaListModulesTool(engine));
    tools.register(new VbaGetModuleTool(engine));
