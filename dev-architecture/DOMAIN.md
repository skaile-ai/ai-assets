...
Architecture skills in this domain produce design documents, ADRs, and integration blueprints — not code. They feed into `dev-implementation` which translates designs into running systems.
...
| `dev-implementation-expert-skill-system` | Design and audit skill system structure and conventions |
...
- Output feeds forward to `dev-implementation` and `dev-conceptualization/30_blueprint/`
