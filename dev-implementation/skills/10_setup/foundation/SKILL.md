...
and layout patterns come from `dev-standards/profiles/<tech_stack_skill>/SKILL.md`.
...
READS
  ...
  dev-standards/profiles/<tech_stack_skill>/SKILL.md  — css_vars_mapping, auth_setup, app_shell recipes
...
`dev-standards/profiles/<tech_stack_skill>/SKILL.md` and extract:
