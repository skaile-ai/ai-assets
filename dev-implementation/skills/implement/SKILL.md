...
`dev-shared/contracts/golden_principles.md` before starting.
...
REFERENCES
  ...
  dev-shared/contracts/golden_principles.md   — entity naming and structure rules
...
STEP 4: Build implementation plan
  ...
  - Write _implementation/PLANS.md (see dev-shared/contracts/plans.md format)
