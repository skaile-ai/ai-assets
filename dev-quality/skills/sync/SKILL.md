...
- `dev-shared/contracts/feedback_loop.md` — cross-reference protocol (authoritative source for link rules)
- `dev-shared/contracts/golden_principles.md` — mechanical rules
...
| `dev-shared/contracts/feedback_loop.md` | Required |
