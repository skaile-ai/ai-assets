...
The `app-e2e` skill utilizes the Vercel `agent-browser` CLI to perform comprehensive end-to-end testing, interact with the application UI, and capture visual artifacts. It also relies on standard database CLI tools for data validation.
...
To enhance the `app-e2e` skill and provide more targeted testing utilities, the following subcommands could be implemented in the future:
