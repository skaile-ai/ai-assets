---
name: "skailup-implement-feature-page"
...
REFERENCES
  ...
  skaileup-standards/profiles/<tech_stack_skill>/SKILL.md — stack-specific patterns
...
PATTERNS (adapt to your stack's test runner):
  describe('<Page Name>', () => {
    beforeAll(async () => { /* reset to populated scenario */ })
