---
name: "prog-expert-tiptap"
description: "Use when you need to use when you need to implement advanced tiptap editors in nuxt 3, including collaboration, custom node views, and context menus.. Expert-level programming and pattern management."
metadata:
  stage: "alpha"
  source: "MIGRATED"
  requires:
...
## Goal
Expert-level project management for Tiptap. Handles complex integrations, gathers knowledge from docs and web research, and maintains a repository of reusable patterns, recipes, atomic examples, and reference implementations.
