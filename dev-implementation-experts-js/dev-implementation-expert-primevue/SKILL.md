...
## Goal
Expert-level project management for Primevue. Handles complex integrations, gathers knowledge from docs and web research, and maintains a repository of reusable patterns, recipes, atomic examples, and reference implementations.
