...
| [word](docx/MCP.md) | `mcp/docx` | alpha (v0.1.0-SNAPSHOT) | Word (.docx) in-place editing via Apache POI XWPF - Block-addressed outline, named styles, tables, Revision/Comment reading, Template consumption; 14 tools over stdio. |
