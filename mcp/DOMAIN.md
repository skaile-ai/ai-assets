...
| [word](docx/MCP.md) | `mcp/docx` | stable (v0.5.0) | Word (.docx) in-place editing and Template composition via Apache POI XWPF — Block-addressed body/header/footer/text-box flows, Named styles, tables, PDF previews, properties/fields, image/media writes, and Revision/Comment collaboration; 37 tools over stdio. |
