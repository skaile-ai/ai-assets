...
| [word](docx/MCP.md) | `mcp/docx` | alpha (v0.2.0) | Word (.docx) in-place editing via Apache POI XWPF - Block-addressed outline, named styles, tables, headers/footers, media inventory, Revision/Comment reading, and Template consumption; 18 tools over stdio. |
