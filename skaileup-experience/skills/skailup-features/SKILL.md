...
REFERENCES
  ...
  skaileup-shared/contracts/feedback_loop.md          — how downstream skills modify feature files
  skaileup-shared/contracts/golden_principles.md      — group naming, entity naming rules
