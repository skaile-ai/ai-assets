...
`dev-shared/contracts/frontmatter.md`, `dev-shared/contracts/feedback_loop.md`,
and `dev-shared/contracts/golden_principles.md` before running any checks.
...
REFERENCES
  dev-shared/contracts/concept_structure.md      — expected phase-grouped paths and folders
  dev-shared/contracts/frontmatter.md            — required YAML fields per file type
  dev-shared/contracts/feedback_loop.md          — cross-reference rules
  dev-shared/contracts/golden_principles.md      — mechanical rules to enforce
  dev-shared/docs/OBSERVABILITY.md              — audit event format
...
MUST  read all dev-shared/contracts/ contracts before any checks
...
STEP 1: Scan pipeline structure
  - Use dev-shared/contracts/concept_structure.md for expected phase-grouped paths
...
STEP 2: Check frontmatter compliance
  - For every .md file in _concept/, verify against dev-shared/contracts/frontmatter.md:
...
STEP 3: Check golden principles
  - For every applicable rule in dev-shared/contracts/golden_principles.md:
...
CHECKLIST
  - [ ] All dev-shared/contracts/ read before checks
...
- **Reads:** `_concept/` (all), `dev-shared/contracts/` (all)
