...
`dev-shared/contracts/frontmatter.md`, and `dev-shared/contracts/semantic_types.md`.
...
REFERENCES
  ...
  dev-shared/contracts/semantic_types.md         — field types (for data flow context)
