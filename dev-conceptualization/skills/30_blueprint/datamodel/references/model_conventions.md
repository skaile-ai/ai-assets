...
All naming follows `dev-shared/contracts/golden_principles.md`.
...
Use semantic types from `dev-shared/contracts/semantic_types.md`. Never use SQL types.
...
See `dev-shared/contracts/seed_data.md` for the authoritative format.
