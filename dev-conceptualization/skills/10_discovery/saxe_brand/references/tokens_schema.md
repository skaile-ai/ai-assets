...
- `tailwind` — CSS custom properties for Radix/Tailwind theming (all --color-* and --radius)

### Downstream Consumers

These skills read tokens.json:

- `concept-2-experience-3-screens` — color and font references in screen specs
- `app-design` — CSS variables and Tailwind theme overrides for `@postxl/ui-components`
