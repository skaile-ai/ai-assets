...
`dev-shared/contracts/frontmatter.md`, `dev-shared/contracts/iron_laws.md`, and
`dev-shared/contracts/agent_patterns.md` before proceeding.
...
| Must read | `dev-shared/contracts/frontmatter.md` | Yes |
