...
Use this structure for each competitor entry in `_concept/1_discovery/2_research/competitors.md`.

## Investigation Checklist

For each comparable product, web-search for:
...
Also capture screenshots or note specific UI patterns worth borrowing or avoiding.
...
- Screenshot: [saved to findings/ if captured]
