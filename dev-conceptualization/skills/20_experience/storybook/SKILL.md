...
**REQUIRED BACKGROUND:** Read `dev-shared/contracts/concept_structure.md` before proceeding.
...
| Must read | `dev-standards/profiles/<tech_stack_skill>/SKILL.md` | Yes |
...
READS
  ...
  dev-standards/profiles/<tech_stack_skill>/SKILL.md     — storybook_addon, story_format, component_library, icon_library
...
REFERENCES
  ...
  dev-shared/contracts/seed_data.md              — scenario convention
...
STEP 1: Resolve tech stack
  ...
  - Read dev-standards/profiles/<tech_stack_skill>/SKILL.md → extract:
    | Field | Purpose |
    |---|---|
