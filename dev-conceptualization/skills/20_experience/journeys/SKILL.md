...
`dev-shared/contracts/frontmatter.md`, and `dev-shared/contracts/acceptance_criteria.md`
before proceeding.
...
REFERENCES
  ...
  dev-shared/contracts/frontmatter.md            — required YAML fields
  dev-shared/contracts/acceptance_criteria.md    — EARS patterns and AC rules
  dev-shared/contracts/stories_schema.json       — JSON Schema for stories.json validation
...
MUST  validate stories.json against dev-shared/contracts/stories_schema.json before writing
...
STEP 3: Map Hero Journey
  ...
  CHECKPOINT hero_approved
    > "Here is the hero journey for [app name]:
    > [brief narrative of the end-to-end flow]
    >
    > Does this capture the core value loop? Confirm or suggest changes before
    > I map the remaining journeys."

  UNTIL user approves
    - Apply requested changes
    - Show updated hero journey and ask for approval again
...
STEP 8: Write stories.json
  ...
  - Validate against dev-shared/contracts/stories_schema.json
...
CHECKLIST
  ...
  - [ ] stories.json validates against dev-shared/contracts/stories_schema.json
