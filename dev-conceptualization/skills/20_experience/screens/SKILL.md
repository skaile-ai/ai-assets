...
`dev-shared/contracts/frontmatter.md`, and `dev-shared/contracts/feedback_loop.md`
before proceeding.
...
REFERENCES
  ...
  dev-shared/contracts/feedback_loop.md          — cross-reference protocol (screens ↔ features)
