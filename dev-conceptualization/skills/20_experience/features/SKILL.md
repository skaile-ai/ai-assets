...
and `dev-shared/contracts/golden_principles.md` before proceeding.
...
REFERENCES
  ...
  dev-shared/contracts/feedback_loop.md          — how downstream skills modify feature files
  dev-shared/contracts/golden_principles.md      — group naming, entity naming rules
...
CHECKLIST
  ...
  - [ ] Group folders use sequential NN_ numbering (no letter prefix)
...
| Letter-prefixed group folders (A_01_) | Agent follows old CF naming convention | Use NN_ prefix only (01_user_auth, not A_01_user_auth). |
