...
sys.path.insert(0, str(Path(__file__).resolve().parents[4] / "dev-shared" / "scripts"))
...
def validate(cwd: str) -> dict:
    ...
    v.skip("read all dev-shared/contracts/ before any checks",
    ...
    v.skip("All dev-shared/contracts/ read before checks",
