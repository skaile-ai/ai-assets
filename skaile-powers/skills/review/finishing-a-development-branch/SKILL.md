...
**Called by:**
- **skaile-powers:subagent-driven-development** (Step 7) - After all tasks complete
- **skaile-powers:executing-plans** (Step 5) - After all batches complete

**Pairs with:**
- **skaile-powers:using-git-worktrees** - Cleans up worktree created by that skill
