...
2. Search for matching expert skills in the monorepo:
   - JS/TS stack: `dev-implementation-experts-js/skills/dev-implementation-expert-<tech>/`
   - Python stack: `dev-implementation-experts-python/skills/dev-implementation-expert-<tech>/`
...
The `dev-implementation-expert-advisor` skill can route to the correct expert
