...
```
REFERENCES
  dev-shared/contracts/semantic_types.md   — field type catalog and translation table
  dev-shared/contracts/feedback_loop.md   — cross-reference protocol
  dev-shared/contracts/golden_principles.md — mechanical rules enforced across artifacts
```
...
`dev-shared/scripts/validate_skill_rules.py` after every skill completes.
