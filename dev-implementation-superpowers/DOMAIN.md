---
name: dev-implementation-superpowers
...
This domain wraps `dev-implementation` with a disciplined meta-workflow for complex features or
...
Use `dev-implementation` directly when:
...
- This domain does NOT replace `dev-implementation`. It orchestrates it. `implement-supervised`
  dispatches `implement-feature` from `dev-implementation` as its implementation worker.
