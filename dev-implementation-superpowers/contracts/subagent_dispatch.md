...
This contract extends `dev-shared/contracts/agent_patterns.md` Pattern: Subagent Dispatch
...
<list of matched dev-implementation-expert-* skills, if any>
...
CASE DONE:
  - Run auto-review checklist (references/auto_review.md in dev-implementation)
